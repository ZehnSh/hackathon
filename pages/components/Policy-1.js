...
export default function Policy1({account}) {
  return (
    <>
      <div className="w-5/6 m-auto">
        <p className="text-center text-xl font-bold">1st POLICY (4 MONTHS)</p>
            ...
            <table className="text-lg">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border-2 border-black p-1">10000</td>
        ...
        <Popup
          ...
          modal nested
        >{
            close=>(<Form account={account} months={4}/>)
        }
